package com.crisn.framework.manager.factory;
...
import com.crisn.common.utils.LogUtil;
import com.crisn.common.utils.ServletUtil;
import com.crisn.common.utils.StringUtil;
import com.crisn.common.utils.ip.AddressUtil;
...
import com.crisn.system.domain.SysOperLog;
import com.crisn.system.service.SysLogininforService;
import com.crisn.system.service.SysOperLogService;
    ...
    public static TimerTask recordLogininfor(final String username, final String status, final String message,
        ...
        return new TimerTask() {
            ...
            public void run() {
                ...
                // 日志状态
                if (StringUtil.equalsAny(status, Const.LOGIN_SUCCESS, Const.LOGOUT, Const.REGISTER)) {
                    logininfor.setStatus(Const.SUCCESS);
                } else if (Const.LOGIN_FAIL.equals(status)) {
                    logininfor.setStatus(Const.FAIL);
                }
                // 插入数据
