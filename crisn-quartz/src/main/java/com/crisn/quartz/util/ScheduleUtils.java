...
import com.crisn.common.exception.job.TaskException;
import com.crisn.common.exception.job.TaskException.Code;
...
public class ScheduleUtils {
    ...
    public static boolean whiteList(String invokeTarget) {
        ...
        if (count > 1) {
            return StringUtil.containsAnyIgnoreCase(invokeTarget, Const.JOB_WHITELIST_STR);
        }
        Object obj = SpringUtil.getBean(StringUtil.split(invokeTarget, ".")[0]);
        return StringUtil.containsAnyIgnoreCase(obj.getClass().getPackage().getName(), Const.JOB_WHITELIST_STR);
    }
}
