package com.crisn.common.utils.file;
...
import com.crisn.common.exception.file.FileNameLengthLimitExceededException;
import com.crisn.common.exception.file.FileSizeLimitExceededException;
import com.crisn.common.exception.file.InvalidExtensionException;
import com.crisn.common.utils.DateUtil;
import com.crisn.common.utils.StringUtil;
import com.crisn.common.utils.uuid.SeqUtil;
...
public class FileUploadUtil {
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = CrisnConfig.getProfile();
    ...
    public static final String extractFilename(MultipartFile file) {
        return StringUtil.format("{}/{}_{}.{}", DateUtil.datePath(),
                FilenameUtils.getBaseName(file.getOriginalFilename()), SeqUtil.getId(SeqUtil.uploadSeqType), getExtension(file));
    }
    ...
    public static final String getPathFileName(String uploadDir, String fileName) throws IOException {
        int dirLastIndex = CrisnConfig.getProfile().length() + 1;
        String currentDir = StringUtil.substring(uploadDir, dirLastIndex);
        return Const.RESOURCE_PREFIX + "/" + currentDir + "/" + fileName;
    }
