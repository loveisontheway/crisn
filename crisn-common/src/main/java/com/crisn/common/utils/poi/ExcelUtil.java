package com.crisn.common.utils.poi;
...
import com.crisn.common.annotation.Excels;
...
import com.crisn.common.exception.UtilException;
import com.crisn.common.utils.DateUtil;
import com.crisn.common.utils.DictUtil;
import com.crisn.common.utils.StringUtil;
import com.crisn.common.utils.reflect.ReflectUtil;
...
import com.crisn.common.utils.file.FileTypeUtil;
import com.crisn.common.utils.file.FileUtil;
import com.crisn.common.utils.file.ImageUtil;
...
public class ExcelUtil<T> {
        ...
        if (rows > 0) {
            ...
            for (int i = titleNum + 1; i <= rows; i++) {
                ...
                for (Map.Entry<Integer, Object[]> entry : fieldsMap.entrySet()) {
                    ...
                    } else if ((Long.TYPE == fieldType || Long.class == fieldType) && StringUtil.isNumeric(Convert.toStr(val))) {
    ...
    public static String convertDictByExp(String dictValue, String dictType, String separator) {
        return DictUtil.getDictLabel(dictType, dictValue, separator);
    }
    ...
    public static String reverseDictByExp(String dictLabel, String dictType, String separator) {
        return DictUtil.getDictValue(dictType, dictLabel, separator);
    }
    ...
    public String getAbsoluteFile(String filename) {
        String downloadPath = CrisnConfig.getDownloadPath() + filename;
