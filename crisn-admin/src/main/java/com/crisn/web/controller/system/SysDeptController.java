...
public class SysDeptController extends BaseController {
    ...
    public AjaxResult add(@Validated @RequestBody SysDept dept) {
        if (UserConst.NOT_UNIQUE.equals(deptService.checkDeptNameUnique(dept))) {
    ...
    public AjaxResult edit(@Validated @RequestBody SysDept dept) {
        ...
        } else if (StringUtil.equals(UserConst.DEPT_DISABLE, dept.getStatus()) && deptService.selectNormalChildrenDeptById(deptId) > 0) {
