...
import com.crisn.framework.web.service.SysPermissionService;
...
public class SysRoleController extends BaseController {
    ...
    public AjaxResult add(@Validated @RequestBody SysRole role) {
        if (UserConst.NOT_UNIQUE.equals(roleService.checkRoleNameUnique(role))) {
            return AjaxResult.error("新增角色'" + role.getRoleName() + "'失败，角色名称已存在");
        } else if (UserConst.NOT_UNIQUE.equals(roleService.checkRoleKeyUnique(role))) {
