...
import com.crisn.common.core.domain.entity.SysDept;
...
import com.crisn.system.mapper.SysDeptMapper;
import com.crisn.system.mapper.SysRoleMapper;
import com.crisn.system.service.SysDeptService;
...
public class SysDeptServiceImpl implements SysDeptService {
    ...
    public int insertDept(SysDept dept) {
        ...
        if (!UserConst.DEPT_NORMAL.equals(info.getStatus())) {
    ...
    public int updateDept(SysDept dept) {
        ...
        if (UserConst.DEPT_NORMAL.equals(dept.getStatus()) && StringUtil.isNotEmpty(dept.getAncestors())
